...
{
    private GCHandle _handle = GCHandle.Alloc(objectNeededPinning ?? throw new ArgumentNullException(nameof(objectNeededPinning)), GCHandleType.Pinned);
    ...
    /// <summary>Same as <see cref="GCHandle.Equals(GCHandle)">GCHandle.Equals</see>.
    /// <para>Indicates whether the current instance is equal to another instance of the same type.</para></summary>
    /// <param name="other">An instance to compare with this instance.</param>
    /// <returns>true if the current instance is equal to the other instance; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Pin<TPinned> other) => this._handle.Equals(other._handle);
    ...
    /// <returns>true if the current instance is equal to the other instance; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(GCHandle other) => _handle.Equals(other);

    /// <summary>Same as <see cref="GCHandle.Equals(GCHandle)">GCHandle.Equals</see>.
    /// <para>Indicates whether the current instance is equal to another instance of the same type.</para></summary>
    /// <param name="other">An instance to compare with this instance.</param>
    /// <returns>true if the current instance is equal to the other instance; otherwise, false.</returns>
    public readonly override bool Equals(object? other) => other is GCHandle obj && _handle.Equals(obj);
    ...
    /// </see>
    /// </summary>
    public static bool operator ==(Pin<TPinned> left, Pin<TPinned> right) => left.Equals(right);
    ...
    /// </see>
    /// </summary>
    public static bool operator !=(Pin<TPinned> left, Pin<TPinned> right) => !(left == right);
...
public static class PinExtension
{
    ...
    extension<TPinned>(TPinned obj) where TPinned : class
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Pin<TPinned> AsPinned() => new(obj);
    }
}
